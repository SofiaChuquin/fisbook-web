...
class CyclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cycle" do
    assert_difference('Cycle.count') do
      post cycles_url, params: { cycle: { name_cycle: @cycle.name_cycle, semester: @cycle.semester, year: @cycle.year } }
    end
  ...
  test "should update cycle" do
    patch cycle_url(@cycle), params: { cycle: { name_cycle: @cycle.name_cycle, semester: @cycle.semester, year: @cycle.year } }
